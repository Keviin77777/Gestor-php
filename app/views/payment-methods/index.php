        ...
        <div class="content-wrapper">
            <div class="payment-methods-page">
                ...
                <div class="payment-providers-grid">
                    ...
                    <!-- Ciabra - Em Breve -->
                    <div class="provider-card provider-card-disabled" data-provider="ciabra">
                        <div class="provider-card-header">
                            <div class="provider-logo ciabra-logo">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <div class="provider-info">
                                <h3>Ciabra <span class="coming-soon-badge">Em Breve</span></h3>
                                <p>Pagamentos via PIX com QR Code</p>
                            </div>
                            <div class="provider-status" id="ciabraStatus">
                                <span class="status-badge status-coming-soon">Em Desenvolvimento</span>
                            </div>
                        </div>
                        <div class="provider-card-body">
                            <button class="btn-configure btn-disabled" disabled>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <circle cx="12" cy="12" r="10"></circle>
