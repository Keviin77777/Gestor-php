            ...
            <div class="balance-grid-modern">
                <div class="modern-balance-card monthly-balance">
                    ...
                    <div class="balance-content-modern">
                        <div class="balance-header-with-badge">
                            <h3 class="balance-title-modern">Saldo Líquido do Mês</h3>
                            <span class="balance-badge monthly-badge"><?php 
                                $meses = ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'];
                                echo $meses[date('n') - 1];
                            ?></span>
                        </div>
                        <div class="balance-value-wrapper">
                            <div class="balance-value-modern" id="monthlyBalance" data-visible="false">••••••</div>
                            <button class="balance-toggle-btn" data-target="monthlyBalance" aria-label="Mostrar/Ocultar valor">
                                <svg class="eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: none;">
                ...
                <div class="modern-balance-card annual-balance">
                    ...
                    <div class="balance-content-modern">
                        <div class="balance-header-with-badge">
                            <h3 class="balance-title-modern">Saldo Líquido do Ano</h3>
                            <span class="balance-badge annual-badge"><?php echo date('Y'); ?></span>
                        </div>
                        <div class="balance-value-wrapper">
                            <div class="balance-value-modern" id="annualBalance" data-visible="false">••••••</div>
                            <button class="balance-toggle-btn" data-target="annualBalance" aria-label="Mostrar/Ocultar valor">
                                <svg class="eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: none;">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
