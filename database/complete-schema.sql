-- UltraGestor - Schema Completo do Banco de Dados
-- Execute este arquivo no phpMyAdmin ou MySQL CLI para criar todas as tabelas
...
-- Tabela de planos de assinatura (para o sistema de assinaturas)
